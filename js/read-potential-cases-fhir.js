...
(async () => {
  ...
  await fs.writeFile("learning-disability-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("learning-disability-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
